...
* Network & Server
* 서버 환경 및 배포 구조
* Cloud Infrastructure 기초

### AI-Assisted Development

* AI를 활용한 ERD / Class Diagram 작성
* 프로젝트 구조 및 코드 분석
* AI가 제안한 내용과 실제 코드·DB 구조 교차 검증
...
[View EduPOP Repository](https://github.com/Eunhye-yoo/EduPOP)
...
서비스의 요구사항을 기술적으로 구체화하고 실제 구현까지 연결할 수 있는 역량을 쌓고 있습니다.

장기적으로는 개발 지식을 기반으로
**서비스와 기술을 함께 이해하고 문제를 구조화할 수 있는 기술 중심의 역할**을 목표로 하고 있습니다.
